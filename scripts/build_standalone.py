...
for filepath, title in files_to_inject:
    if os.path.exists(filepath):
        ...
        cells.append(create_code_cell(read_file(filepath)))

cells.append(create_markdown_cell("## 🚀 Execution Phase"))
cells.append(create_code_cell(
    "# 1. Organize Dataset\n"
...
with open('standalone_colab.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)

print("✅ Successfully generated standalone_colab.ipynb!")
